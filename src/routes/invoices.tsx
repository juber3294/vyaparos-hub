...
export const Route = createFileRoute("/invoices")({
  head: () => ({ meta: [{ title: "Invoices — VyaparOS" }, { name: "description", content: "All invoices with GST and payment status." }] }),
...
function InvoicesPage() {
  ...
  return (
    <AppShell title="Invoices" subtitle="Every invoice, one place" actions={<Btn><Plus className="h-4 w-4" /> New Invoice</Btn>}>
