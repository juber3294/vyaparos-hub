...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Cloud ERP for Indian wholesale & retail: billing, GST, inventory, AI insights.",
      },
      { property: "og:title", content: "VyaparOS — Smart Business OS" },
      {
        property: "og:description",
        content: "Modern ERP for Indian businesses with AI-powered insights.",
      },
    ],
  }),
  component: Dashboard,
